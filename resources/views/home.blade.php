...
<html lang="id">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Daftar Berobat</a>
            </li>
            <li class="nav-item">
              <a class="btn btn-primary ms-lg-3" href="{{ route('login.form') }}">Login</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section class="section-alt">
      <div class="container">
        <h3 class="text-center">Daftar Berobat di Klinik Sehat</h3>
        <p class="text-center">
          Daftar untuk berobat dengan mengisi form di bawah ini
        </p>
